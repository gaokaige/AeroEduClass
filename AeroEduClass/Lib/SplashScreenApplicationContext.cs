...
namespace AeroEduClass.Lib
{
    ...
    public abstract class SplashScreenApplicationContext : ApplicationContext
    {
        ...
        private void ShowSplashScreen()
        {
            ...
            this._SplashScreenTimer = new System.Timers.Timer(
                ((double)(this._SplashScreenTimerInterVal)));
            _SplashScreenTimer.Elapsed += new System.Timers.ElapsedEventHandler(
                new System.Timers.ElapsedEventHandler(this.SplashScreenDisplayTimeUp));
            this._SplashScreenTimer.AutoReset = false;
            Thread DisplaySpashScreenThread = new Thread(
                new ThreadStart(DisplaySplashScreen));
        ...
        private void MainFormLoad()
        {
            ...
            DisposeDelegate SplashScreenFormDisposeDelegate = new DisposeDelegate(this._SplashScreenForm.Hide);
